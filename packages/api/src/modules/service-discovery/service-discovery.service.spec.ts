...
describe('ServiceDiscoveryService (BDD)', () => {
  ...
  describe('discoverFromConnection', () => {
    it('should throw NotFoundException when connection not found', async () => {
      ...
      await expect(service.discoverFromConnection('non-existent')).rejects.toThrow(
        NotFoundException
      );
    });
    ...
    it('should throw BadRequestException for non-code_source integrations', async () => {
      ...
      mockPrismaService.integrationConnection.findUnique.mockResolvedValue(connection);
  ...
  describe('discoverFromGitHub', () => {
    ...
    it('should update existing non-rejected suggestions', async () => {
      ...
      mockPrismaService.serviceSuggestion.findFirst.mockResolvedValue(existingSuggestion);
    ...
    it('should not update rejected or ignored suggestions', async () => {
      ...
      mockPrismaService.serviceSuggestion.findFirst.mockResolvedValue(rejectedSuggestion);
      mockPrismaService.serviceSuggestion.create.mockResolvedValue({
        id: 'sugg-124',
        connectionId: 'conn-123',
        suggestedName: 'repo',
  ...
  describe('getPendingSuggestions', () => {
    it('should return all pending suggestions', async () => {
      ...
      mockPrismaService.serviceSuggestion.findMany.mockResolvedValue(suggestions);
  ...
  describe('acceptSuggestion', () => {
    ...
    it('should throw BadRequestException for non-pending suggestions', async () => {
      ...
      mockPrismaService.serviceSuggestion.findUnique.mockResolvedValue(suggestion);
  ...
  describe('acceptMultiple', () => {
    it('should accept multiple suggestions', async () => {
      ...
      const result = await service.acceptMultiple(['sugg-1', 'sugg-2'], overrides);

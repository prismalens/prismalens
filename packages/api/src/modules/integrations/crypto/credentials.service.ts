...
export class CredentialsService implements OnModuleInit {
	...
	private initializeEncryptionKey(): void {
		...
		// Key is now guaranteed by @prismalens/config (auto-generated if not set)
		if (!keyHex) {
			throw new Error(
				"PRISMALENS_ENCRYPTION_KEY not available. This should not happen - " +
		...
		try {
			...
			throw new Error(
				`Failed to initialize encryption key: ${error instanceof Error ? error.message : "invalid hex string"}`,
			);
		}
	}

...
import type { Service, ServiceDependency } from '../../../prisma/generated/client.js';
...
export class ServicesService {
  ...
  async addDependency(
    ...
    try {
      ...
      this.logger.log(`Added dependency ${dto.dependencyId} to service ${serviceId}`);
      return dependency;
    } catch {
      return null;
    }
   ...
   * Remove a dependency
   */
  async removeDependency(serviceId: string, dependencyId: string): Promise<boolean> {
    try {

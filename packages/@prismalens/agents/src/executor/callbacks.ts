...
import type { AgentExecutionRecord, ToolExecutionRecord } from '../types/state.js';
...
export class ExecutionTracker {
     ...
     */
    startAgentExecution(agentName: string, agentType: 'llm' | 'sequential' | 'loop' = 'llm'): void {
     ...
     */
    recordToolExecution(execution: Omit<ToolExecutionRecord, 'executedAt'>): void {

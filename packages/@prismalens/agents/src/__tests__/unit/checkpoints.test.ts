...
describe("checkpoints", () => {
  ...
  describe("getBestHypothesis", () => {
    ...
    it("should return null for state object with no hypotheses", () => {
      expect(getBestHypothesis({ hypotheses: [] })).toBeNull()
      expect(getBestHypothesis({ hypotheses: undefined })).toBeNull()
    })

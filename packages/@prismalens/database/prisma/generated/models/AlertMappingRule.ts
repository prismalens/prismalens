...
type GetAlertMappingRuleGroupByPayload<T extends AlertMappingRuleGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<AlertMappingRuleGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof AlertMappingRuleGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
...
export type AlertMappingRuleCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<AlertMappingRuleFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface AlertMappingRuleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['AlertMappingRule'], meta: { name: 'AlertMappingRule' } }
  /**
  ...
  count<T extends AlertMappingRuleCountArgs>(
    ...
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], AlertMappingRuleCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, AlertMappingRuleGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAlertMappingRuleGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

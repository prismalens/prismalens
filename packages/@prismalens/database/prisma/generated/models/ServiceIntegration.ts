...
export type GetServiceIntegrationAggregateType<T extends ServiceIntegrationAggregateArgs> = {
      [P in keyof T & keyof AggregateServiceIntegration]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
...
type GetServiceIntegrationGroupByPayload<T extends ServiceIntegrationGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ServiceIntegrationGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ServiceIntegrationGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
...
export type ServiceIntegrationCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ServiceIntegrationFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ServiceIntegrationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ServiceIntegration'], meta: { name: 'ServiceIntegration' } }
  /**
  ...
  count<T extends ServiceIntegrationCountArgs>(
    ...
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ServiceIntegrationCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, ServiceIntegrationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetServiceIntegrationGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**

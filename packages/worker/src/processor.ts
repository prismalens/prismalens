...
import { InvestigationJobData, InvestigationResult } from './types.js';
import {
...
export async function processInvestigationJob(
    ...
    try {
        ...
        await job.updateProgress({ percent: 10, message: 'Starting investigation...' });
...
function buildExecutorInput(jobData: InvestigationJobData): InvestigationInput {
    ...
    const integrations: IntegrationContext[] = (
        ...
        serviceOverrides: int.serviceOverrides as Record<string, unknown> | undefined,
    }));

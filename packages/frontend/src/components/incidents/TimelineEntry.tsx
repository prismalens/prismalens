...
const entryStyles: Record<TimelineEntryType, EntryStyle> = {
	incident_created: {
		...
		color: "text-stale",
		bgColor: "bg-stale/12",
		borderColor: "border-stale/35",
	},
	alert_added: {
		icon: Bell,
		color: "text-sev-low",
		bgColor: "bg-sev-low/12",
		borderColor: "border-sev-low/35",
	},
	alert_removed: {
		icon: MinusCircle,
	...
	severity_changed: {
		icon: AlertCircle,
		color: "text-sev-high",
		bgColor: "bg-sev-high/12",
		borderColor: "border-sev-high/35",
	},
	assigned: {
		icon: UserPlus,
		color: "text-primary",
	...
	investigation_completed: {
		icon: Bot,
		color: "text-run-done",
		bgColor: "bg-run-done/12",
		borderColor: "border-run-done/35",
	},

...
export function AlertDetail({ alertId }: { alertId: string }) {
	...
	return (
		<div className="-mt-6" data-testid="alert-detail">
			<div className="sticky top-0 z-30 -mx-4 border-b bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/80 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">

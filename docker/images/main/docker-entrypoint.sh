...
# PrismaLens Main Server Entrypoint
# Handles runtime configuration for NestJS API + Frontend

echo "Starting PrismaLens Main Server (Edition: ${PRISMALENS_EDITION:-COMMUNITY})"
